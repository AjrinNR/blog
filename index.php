    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="post">
                        <a class="post-img" href="blog-post.html"><img src="/admin/artikel/img/<?php echo $data['foto'];?>" alt=""></a>
                        <div class="post-body">
                            <div class="post-meta">
                                <a class="post-category cat-1" href="blog.php"><?php echo $data['nama_kategori'];?></a>
                                <span class="post-date">March 27, 2018</span>
                            </div>
                            <h3 class="post-title"><a href="blog-post.html"><?php echo $data['judul'];?></a></h3>
                        </div>
                    </div>
                </div>
                <?php   }
